\hypertarget{class__export_8h}{}\section{/home/flo/work/ros/workspaces/ow\+\_\+ws/src/ow\+\_\+core/include/ow\+\_\+core/plugins/class\+\_\+export.h File Reference}
\label{class__export_8h}\index{/home/flo/work/ros/workspaces/ow\+\_\+ws/src/ow\+\_\+core/include/ow\+\_\+core/plugins/class\+\_\+export.\+h@{/home/flo/work/ros/workspaces/ow\+\_\+ws/src/ow\+\_\+core/include/ow\+\_\+core/plugins/class\+\_\+export.\+h}}
...
\begin{DoxyNote}{Note}
Use this macro only once per .so file! 
\end{DoxyNote}
\index{class\+\_\+export.\+h@{class\+\_\+export.\+h}!O\+W\+\_\+\+P\+L\+U\+G\+I\+N\+\_\+\+C\+L\+A\+S\+S\+\_\+\+C\+R\+E\+A\+TE@{O\+W\+\_\+\+P\+L\+U\+G\+I\+N\+\_\+\+C\+L\+A\+S\+S\+\_\+\+C\+R\+E\+A\+TE}}
...
\begin{DoxyNote}{Note}
The static\+\_\+cast from \textquotesingle{}Class$\ast$\textquotesingle{} to \textquotesingle{}I\+Generic\+Class$\ast$\textquotesingle{} is essential. The void$\ast$ is casted back with reinterpret\+\_\+cast to \textquotesingle{}I\+Generic\+Class$\ast$\textquotesingle{}. This fails with seg fault when not previously using static\+\_\+cast.

The upcasting from \textquotesingle{}I\+Generic\+Class$\ast$\textquotesingle{} to \textquotesingle{}Class$\ast$\textquotesingle{} must be again done with static\+\_\+cast!

Use this macro only once per .so file! 
\end{DoxyNote}
\index{class\+\_\+export.\+h@{class\+\_\+export.\+h}!O\+W\+\_\+\+P\+L\+U\+G\+I\+N\+\_\+\+C\+L\+A\+S\+S\+\_\+\+D\+E\+S\+T\+R\+OY@{O\+W\+\_\+\+P\+L\+U\+G\+I\+N\+\_\+\+C\+L\+A\+S\+S\+\_\+\+D\+E\+S\+T\+R\+OY}}
...
\{ \(\backslash\)
  ...
  \{ \(\backslash\)
    ow\_core::IGenericClass* g = \(\backslash\)
      reinterpret\_cast<\hyperlink{classow__core_1_1IGenericClass}{ow\_core::IGenericClass}*>(ptr); \(\backslash\)
...
\begin{DoxyNote}{Note}
The destruction should run from top to down (should be less error prone than down to top).

Since classes should be created by the factory they should also be deleted by the factory to avoid memory corruptions when the .so file has been compiled with a different compiler (version) then the loader of the .so file.
